...
df = pd.read_parquet("data/cmcqrd/cmcqrd_pairs.parquet")
...
# write_jsonl("data/cmcqrd/cmcqrd_pairs_o3.jsonl", messages)
...
# write_jsonl("data/cmcqrd/cmcqrd_pairs_gemini.jsonl", messages)
...
#     file="data/cmcqrd/cmcqrd_pairs_gemini.jsonl",
