...
pairs_results = pd.read_parquet("results/jee/jee_pairs_results.parquet")
...
df.set_index("Question Number", inplace=True)
...
# df.to_parquet("results/jee/jee_with_bt.parquet", index=False)
