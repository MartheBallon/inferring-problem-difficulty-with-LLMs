...
df = pd.read_parquet("data/omni/omni_pairs.parquet")
...
# write_jsonl("data/omni/omni_pairs_o3.jsonl", messages)
...
# write_jsonl("data/omni/omni_pairs_gemini.jsonl", messages)
...
#     file="data/omni/omni_pairs_gemini.jsonl",
